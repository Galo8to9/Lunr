  ...
  <div className="absolute inset-0 [mask-image:radial-gradient(85%_85%_at_50%_45%,black,transparent)]">
    ...
    >
      <div
        ...
        style={{
          backgroundImage: `
            radial-gradient(calc(34rem * var(--blob-scale)) calc(28rem * var(--blob-scale)) at 50% 38%, rgba(0, 157, 255, 0.45), transparent 60%),
            radial-gradient(calc(32rem * var(--blob-scale)) calc(26rem * var(--blob-scale)) at 62% 52%, rgba(31, 155, 66, 0.75), transparent 60%),
            radial-gradient(calc(30rem * var(--blob-scale)) calc(24rem * var(--blob-scale)) at 38% 56%, rgba(0,180,255,0.30), transparent 60%),
            radial-gradient(calc(36rem * var(--blob-scale)) calc(28rem * var(--blob-scale)) at 50% 70%, rgba(123, 180, 43, 0.69), transparent 65%)
          `,
        }}
      />
    </div>
...
{/* Ultra-fine speckle */}
<div className="pointer-events-none absolute inset-0 opacity-55 mix-blend-multiply dark:mix-blend-screen" style={{filter: "contrast(165%) brightness(95%)"}}>
  <div
    className="h-full w-full"
    style={{
      backgroundImage: `
...
{/* Fine grain */}
<div className="pointer-events-none absolute inset-0 opacity-45 mix-blend-multiply dark:mix-blend-screen" style={{filter: "contrast(150%)"}}>
  <div
    className="h-full w-full"
    style={{
      backgroundImage: `
...
<div className="pointer-events-none absolute inset-0 opacity-30 mix-blend-multiply dark:mix-blend-screen" style={{filter: "contrast(140%)"}}>
  <div
    className="h-full w-full"
    style={{
      backgroundImage: `
    ...
    />
      ...
      <div className="relative z-10">
        <Container>
          <div className="max-w-5xl px-6 py-24 sm:py-28 lg:py-48 text-left">
            ...
            >
              Lunr simplifies crypto cross-chain solvency audits by generating verifiable, on-chain proofs of reserves.
            </motion.h1>
            ...
            >
              Cross-chain payments made simple — any token in, your preferred asset out.
            </motion.p>
      ...
      <style jsx global>{`
        @keyframes float {
          ...
          50% { transform: translate3d(-2%, -3%, 0) rotate(0.0001deg); }
